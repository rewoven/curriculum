...
#
#     PHX_SERVER=true bin/rewoven_curriculum start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :rewoven_curriculum, RewovenCurriculumWeb.Endpoint, server: true
end

config :rewoven_curriculum, RewovenCurriculumWeb.Endpoint,
  http: [port: String.to_integer(System.get_env("PORT", "4000"))]

# Supabase config — same project as the rest of Rewoven.
...
if config_env() == :prod do
  ...
  config :rewoven_curriculum, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
